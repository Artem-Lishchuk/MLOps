...
def train_model():
    ...
    mlflow.set_experiment("tip_applied_logreg")
    ...
    for params in ParameterGrid(param_grid):
        with mlflow.start_run():
            ...
            model = LogisticRegression(**params, penalty="l2", solver="lbfgs", max_iter=1000, random_state=113)
    ...
    with mlflow.start_run(run_name="best_logistic_regression") as best_run:
        mlflow.set_tag("model_family", "logistic_regression")
    ...
    mlflow.register_model(model_uri, "tip_applied_logistic_regression")
