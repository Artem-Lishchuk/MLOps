...
def train_model():
    ...
    mlflow.set_experiment("tip_applied_rf")
    ...
    with mlflow.start_run(run_name="best_random_forest") as best_run:
        mlflow.set_tag("model_family", "random_forest")
    ...
    mlflow.register_model(model_uri, "tip_applied_random_forest")
